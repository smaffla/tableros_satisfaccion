...
## FunciC3n grC!fico de barras para df caracterizacion
...
## FunciC3n grC!fico de barras AGRUPADO para df caracterizacion
...
categorica_2var <- function(x, cat1, cat2, rename, encabezado = NULL, title = NULL, label_width = NULL) {
  ...
  # Personalizar el tamaC1o de las etiquetas de columna
...
categorica_2var_escala <- function(x, cat1, cat2, rename, encabezado = NULL, title = NULL, label_width = NULL) {
  ...
  # Definir el orden fijo de las categorC-as
  ...
  table <- x %>% 
    ...
    group_by(!!cat1) %>% 
    pivot_wider(names_from = !!cat2, values_from = n, values_fill = 0) %>%
    # Asegurar que todas las categorC-as estC)n presentes y en el orden correcto
...
categorica_vinculacion_modalidad <- function(x, cat1, cat2, rename, encabezado = NULL, title = NULL, label_width = NULL) {
  ...
  # Definir el orden fijo de las categorC-as
  orden_categorias <- c("Contrato de prestaciC3n de servicios", "ResoluciC3n de incentivos", "Otra")
...
percepcion <- read.xlsx("Encuesta de percepcion (2024-I)(1-6) (2).xlsx", sheet = "Sheet1")
