...
talento <- talento %>%
  ...
  mutate(unidad_o_dependencia = case_when(
    ...
    unidad_o_dependencia %in% c("Centro de Innovación Y Desarrollo Educativo Y Tecnológico - Cinndet") ~ "Cinndet", 
    ...
    unidad_o_dependencia %in% c("Facultad de Educacion", "Fed", "Licenciatura Educación Especial",
                                "Licenciatura Educacion Infantil", "Licenciatura En Educación Infantil", "Leco") ~ "Facultad de Educación",
  ...
  mutate(unidad_o_dependencia = case_when(
    unidad_o_dependencia %in% c("Subdirección de Biblioteca, Documentación Y Recursos Bibliográficos",
                                "Subdirección de Admisiones Y Registros", "Docente") ~
    ...
    unidad_o_dependencia %in% c("Subdirección de Bienestar Universitario", "Grupo de Contratación",
                                ...
                                "Certificaciones Laborales", "Subdirección Financiera", "Spe-Sst"
