...
#Depuración para gar -base de datos encuesta GAR 2023 - 1
gar_20231 <- gar_20231 %>% 
  distinct()
...
#Depuración para gar - base de datos encuesta GAR 2023-2
gar_20232 <- gar_20232 %>% 
  distinct()
...
#Depuración para gar -base de datos encuesta GAR rbind
gar <- gar %>% 
  distinct()
...
##❗❗❗Descomente el siguiente código hasta al final de

# 
# # calidad_202422 <- calidad_20242 %>% 
# #   distinct()
# # 
# # 
# # calidad_20242 <- calidad_20242 %>% 
# #   clean_names()
# # 
# # calidad_20242 <- calidad_20242 %>% 
# #   mutate(hora_de_finalizacion = as.Date(hora_de_finalizacion, origin = "1899-12-30")) %>% 
...
# #                            "FFacultad de Humanidades" = "Facultad de Humanidades"))
# 
# # ##Depuración varibale de 2024 completa
